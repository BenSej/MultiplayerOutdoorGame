        ...
        for (JsonElement g : games) {
            ...
            if (summary.isOngoing(myEmail)) {
                ...
                leave.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(final View v) {
                        WebApi.startRequest(MainActivity.this, WebApi.API_BASE
                                + "/games/" + gameId + "/leave", Request.Method.POST,
                                null, response -> {
                ...
                accept.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(final View v) {
                        WebApi.startRequest(MainActivity.this, WebApi.API_BASE
                                + "/games/" + gameId + "/accept", Request.Method.POST,
                                null, response -> {
                            // response code handler similar to a GET request
                                connect();
                            },  error -> {
                ...
                decline.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(final View v) {
                        WebApi.startRequest(MainActivity.this, WebApi.API_BASE
                                + "/games/" + gameId + "/decline", Request.Method.POST,
                                null, response -> {
                                connect();
                            },  error -> {
                            });
