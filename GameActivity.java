...
public final class GameActivity extends AppCompatActivity {
    ...
    private void onLocationUpdate(final Location location) {
        ...
        if (game == null || webSocket == null || game.getMyTeam() == TeamID.OBSERVER) {
            return;
        }
        ...
        locUpdate.addProperty("latitude", latitude);
        locUpdate.addProperty("longitude", longitude);
        ...
        switch (type) {
            ...
            case "gameState":
                ...
                if (newState != GameStateID.ENDED) {
                    ...
                    int teamId = game.getWinningTeam();
                    String[] teamNames = this.getResources().getStringArray(R.array.team_choices);
                    String teamName = teamNames[teamId];
                    AlertDialog.Builder builder = new AlertDialog.Builder(this);
                    builder.setMessage(teamName + " wins!");
                    builder.setOnDismissListener(unused -> finish());
                    builder.setNegativeButton("LEAVE", (unused1, unused2) -> finish());
                    builder.create().show();
                }
    ...
    private void connectWebSocket() {
        ...
        WebApi.connectWebSocket(WebApi.WEBSOCKET_BASE + "/games/" + gameId + "/play",
            ...
            ws -> webSocket = ws, () -> runOnUiThread(this::connectWebSocket),
            error -> runOnUiThread(() -> {
    ...
    private void gameLifecycleControl(final String action) {
        WebApi.startRequest(this, WebApi.API_BASE + "/games/" + gameId + "/" + action,
                Request.Method.POST, null, unused -> { },
            error -> Toast.makeText(this, R.string.connection_failed,
